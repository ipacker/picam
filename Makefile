...
LDFLAGS=-g -Wl,--whole-archive -lilclient -L/opt/vc/lib/ -L/writeable/ffmpeg_build/lib/ -L/usr/local/lib -lGLESv2 -lEGL -lopenmaxil -lbcm_host -lvcos -lvchiq_arm -lpthread -lrt -L/opt/vc/src/hello_pi/libs/ilclient -Wl,--no-whole-archive -rdynamic -lmmal -lmmal_core -lmmal_util -lm -lswresample -lbz2 -ldl -lfdk-aac -lcrypto -lasound `freetype-config --libs` `pkg-config --libs harfbuzz fontconfig libavformat libavcodec libavutil`
